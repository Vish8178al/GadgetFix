...
%>
  ...
  <h4 class="bg-primary text-white p-2 text-center">All Enquiries...!</h4>
  <div >
  <%
...
%>
 ...
 <p class="bg-light p-2 m-2"> 
  ...
  <a class="btn btn-success btn-sm" href="ChangeEnquiryStatus?phone=<%=enquiry.get("phone")%>&status=Done">Done</a>
  </p>
