      ...
      <div class="col-sm">
          <div class="bg-info p-4">
            ...
            <form method="post" action="AddRepairExpert" enctype="multipart/form-data">
                <input name="email" class="form-control p-4 my-2" type="text"  placeholder="Email" required />
                <input name="name" class="form-control p-4 my-2" type="text" maxlength="100"  placeholder="Name" required />
                <input name="phone" class="form-control p-4 my-2" type="tel"  maxlength="10" placeholder="Phone" required />
                <input name="state" class="form-control p-4 my-2" type="text"  placeholder="State" required />
                <input name="city" class="form-control p-4 my-2" type="text"  placeholder="City" required />
                <input name="sector" class="form-control p-4 my-2" type="text"  placeholder="Sector(Village)" required />
                <input name="photo" class="form-control p-4 my-2" type="file" accept=".jpg,.png,.jpeg" required />
        ...
        <div class="col-sm">
          <div class="bg-secondary p-4">
            ...
            <form method="post" action="RepairExpertsSearch.jsp">
                 <input name="state" class="form-control p-4 my-2" type="text"  placeholder="State" required />
                <input name="city" class="form-control p-4 my-2" type="text"  placeholder="City" required />
                <input name="sector" class="form-control p-4 my-2" type="text"  placeholder="Sector(Village)">
                <button class="btn btn-primary my-2">Search</button>
            </form>
          </div>
         
          <div >
          <h4 class="bg-primary text-white p-3 text-center mt-2">All Repair Experts...!</h4>
  <%
